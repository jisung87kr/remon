...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'nick_name', 'sex', 'birthdate', 'phone', 'phone_verified_at', 'status', 'level', 'point', 'agree_email', 'agree_sms', 'agree_push', 'bank_name', 'account_number', 'account_holder',
    ];
