...
class CampaignService{
    ...
    public function upsert()
    {
        $validated = $this->request->validate([
            ...
            'registration_start_date_at'     => 'nullable|date',
            'registration_end_date_at'       => 'required|date',
            'result_announcement_date_at'    => 'nullable|date',
            ...
            'thumbnails.*'                   => 'required|image|mimes:jpeg,png,jpg,gif|max:10240',
            'detail_images.*'                => 'required|image|mimes:jpeg,png,jpg,gif|max:10240',
        ...
        try {
            ...
            $campaign = Campaign::updateOrCreate([
                ...
                'registration_start_date_at'  => $validated['registration_start_date_at'] ?? null,
                'registration_end_date_at'    => $validated['registration_end_date_at'],
                'result_announcement_date_at' => $validated['result_announcement_date_at'] ?? null,
