                                ...
                                <div class="shrink-0 mr-3 w-[100px]">
                                    <div class="relative">
                                        <img src="https://placeholder.co/300x300" alt=""
                                             class="w-full overflow-hidden rounded block">
                                        <button class="absolute right-2 top-2">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                 class="icon icon-tabler icon-tabler-heart" width="18" height="18"
                        ...
                        @foreach(range(1, 5) as $key)
                            <div class=relative>
                                <div class="relative">
                                    ...
                                    <img src="https://files.weble.net/campaign/data/868930/thumb200.jpg?bust=1705817017068"
                                         alt="">
                                    <button class="absolute right-3 top-3">
                                        <svg xmlns="http://www.w3.org/2000/svg"
