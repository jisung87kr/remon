<x-mypage-layout>
    ...
    {{-- 출금 요청 폼 --}}
    <div class="card mb-6 bg-gradient-to-r from-gray-50 to-slate-50 p-5 md:p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('mypage.account.edit') }}" class="text-sm text-blue-600 hover:text-blue-800 font-medium flex items-center">
                <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"/>
                </svg>
                계좌 정보 {{ auth()->user()->bank_name ? '수정' : '등록' }}
            </a>
        </div>
        <form action="{{ route('mypage.withdrawal-request.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                    ...
                    <input type="text" name="account_number" value="{{ old('account_number', auth()->user()->account_number) }}"
                ...
                <div>
                    ...
                    <input type="text" name="account_holder" value="{{ old('account_holder', auth()->user()->account_holder) }}"
